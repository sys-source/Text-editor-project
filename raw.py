...
def open_settings():
    ...
    settings_button_for_font = Button(window, bg=dark_theme[0], text=size, fg=dark_theme[1], font=(30), height=2, width=20, activebackground=dark_theme[0], activeforeground=dark_theme[1])
